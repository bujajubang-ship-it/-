...
- introScript(⑥ 도입부 원고): introA beat 순서·심리 기제를 유지하되 소재는 내 주제로. 30초, 구어체, 문장 끊어서. ★반드시 지킬 것★ (1) 섬네일/제목 문구를 도입부 30초 안에 '받아주기(callback)' — 시청자가 그 문구 보고 눌렀으니 그 약속을 도입부에서 짚어줘야 끝까지 봄. (2) 섬네일이 준 기대치를 '넘는' 임팩트를 줄 것(기대 이상의 반전·수치·장면).
