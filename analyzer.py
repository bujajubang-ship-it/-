...
- ★★케이스(가설) 먼저★★: 막연한 '식당 사장님' 말고 **구체적인 한 명의 대표 케이스(A사장님)**를 세우고, '그 사장님이 겪는 이 문제를 이렇게 해결한다'는 구조로 전체를 짜라. (예: 'A사장님 — 3평 분식집 5년차, 혼자 운영, 점심 피크에 동선 꼬여 주문 밀림'처럼 구체적으로) 이 A사장님은 반드시 ②에서 운영자가 실제로 본 사례 기반의 대표 케이스여야 함(특정인 조작 금지, 없는 사례 지어내기 금지). 구체적일수록 시청자가 "저거 완전 나잖아" 한다.
...
{{
  ...
  "caseSetup": {{"who":"구체적 대표 케이스 A사장님 프로필 (②실제 관찰 기반 — 예: 3평 분식집 5년차, 혼자 운영)","problem":"그 사장님이 겪는 구체적 문제 (이 영상이 풀 것)","typical":"왜 이게 수많은 시청자의 전형인지 (그래서 다들 '내 얘기' 함)"}},
