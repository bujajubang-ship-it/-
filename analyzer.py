...
{{
  ...
  "draft": {{
    ...
    "full_text": "완성 블로그 초안 — 사진 8장에 맞춰 단락 8개, 각 단락 80~100자, 전체 700~800자, 메인 키워드 8~10회 자연스럽게 반복, 억지 나열 금지"
  }}
}}

title_candidates 3개 작성하세요.
hashtags.tags는 경쟁도 낮음=3개, 중간=2개, 높음=1개만 작성하세요.
draft.full_text는 사진 순서에 맞게 단락을 [사진1] [사진2] ... [사진8] 라벨로 구분하고, 각 단락은 정확히 80~100자로 작성하세요. 전체 700~800자를 엄수하세요."""
