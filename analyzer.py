...
- introScript(⑥ 도입부 원고): introA에서 뽑은 beat 순서·심리 기제를 그대로 유지하고 소재만 내 주제로 갈아끼운 실제 대본. 30초 분량, 구어체, 문장을 끊어서 줄바꿈. (베끼지 말고 뼈대만 이식)
- bodyScript(⑦ 본문 원고): 문제→이유→해결→이득 순서, 구어체. empathy의 실제 댓글에서 드러난 시청자 욕구·불안을 본문에 직접 녹일 것.
