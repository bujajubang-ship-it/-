...
0) ★가장 먼저★ '끝점(고객 언어)' 설계 — 이 영상 본 시청자(식당 사장)가 뒤에서 서로/지인에게 뭐라 말할지 대화체로 예상. '시청자의 마음'을 적어줬으면 그게 나오도록. (예: "소탈·진정성 있어서 도와주고 싶더라", "안 팔려고 하고 진짜 알려주네", "공감가서 지인한테 보냈잖아") 이 반응이 나오게 나머지를 역산.
1) '마음을 움직이는 공감 장면'을 운영자가 실제 촬영 가능한 환경(매장/창고/고객 주방 현장)에서, '내가 본 사장님 사례'를 날것으로 보여주는 방식으로 설계.
2) 공감·사례는 절대 지어내지 말고 위 '사장님 사례'·실제 댓글·카페에서만 인용. 제품/현실 디테일은 '팩트' 범위 안에서만(틀린 디테일=마음 닫힘).
3) 목적은 '이 사람 안 팔려고 하고 진짜 도와주네' 느낌 → 응원. 판매는 그 위에 얹기.
