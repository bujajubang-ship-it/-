...
아래 JSON으로 작성하세요:
{{
  "viewerMirror": "★거울★ 이 영상이 '정확히 비춰줄' 시청자(식당 사장)의 구체적 현실·아픔 — 시청자가 '딱 내 얘기네' 하고 무장해제되는 지점 (그들의 상황을 그들 입장에서 한 문단)",
  "viewerTalk": ["★끝점★ 이 영상 본 시청자가 뒤에서 서로/지인에게 나눌 예상 대화 3~4개 (실제 말투 대화체). 이게 기획의 목표점."],
  "coreEmotion": "이 영상이 시청자(식당 사장) 마음속에서 건드리는 진짜 감정 한 문장 (시청자 입장)",
  "empathyScenes": [{{"scene":"시청자 자신의 현실을 비추는 공감 장면(촬영·연출 가능하게 구체적으로)","why":"이 장면에서 시청자가 왜 '내 얘기다' 느끼는지","place":"영상 어디에 넣을지(도입/전개/절정 등)"}}],
  "empathyPoints": [{{"quote":"실제 댓글/카페/사장님 사례 원문","source":"출처","insight":"이 안에 담긴 시청자의 진짜 마음"}}],
  "authenticity": "조력자로서 드러낼 진정성 포인트 — 어떤 솔직함('저 요리는 못 하는데')·관찰자 권위를 보여줘야 시청자 마음이 열리는지 (못난이 정서 활용, 식당 1인칭 조작 금지)",
  ...
  "titles": ["감정·진정성 기반 제목 3~5개",
             "(기술적 후킹보다 마음을 건드리는 쪽)"],
  "introScript": "마음을 여는 도입부 대본 — 반드시 '시청자 얘기'로 시작(그들의 상황·아픔을 정면으로 콕 짚어 '딱 내 얘기다' 만들기), 그 다음 조력자로. 구어체, 문장 끊어서",
